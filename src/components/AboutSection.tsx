      ...
      <div
        ...
        <div className="container max-w-7xl mx-auto md:px-10 px-5">
          <div className="w-full flex flex-wrap md:flex-nowrap items-center justify-between mb-10">
            <p className="logo-title text-4xl font-medium">
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 gap-4">
            ...
            <div className="p-5 border border-slate-400 shadow custom-gradient">
              <h1 className="logo-title uppercase text-xl md:text-2xl font-medium text-slate-100 mb-4">
            ...
            <div className="p-5 border border-slate-400 shadow custom-gradient">
              ...
              <p className="text-slate-100 font-light">
                Principals' Conclave 2025 is a premier platform designed to
                bring together forward-thinking School and Polytechnic
                Principals dedicated to shaping the future of learning. As key
                architects of academic excellence, principals and institutional
                heads play a crucial role in driving innovation, ensuring
                student success, and adapting to the ever-evolving educational
                landscape.
              </p>
            </div>
          </div>
