				...
				<ul className='hidden xl:flex space-x-4 items-center'>
					{[
						...
						<li key={item.path} className='px-3 content-center relative'>
							<Link
								to={item.path}
								className={`uppercase text-white relative inline-block pb-2 after:content-[''] after:absolute after:left-0 after:bottom-0 after:h-[4px] after:w-full after:rounded-sm ${
					...
					<ul className='p-4 space-y-4'>
						{[
							...
							<li key={item.path}>
								<Link
									to={item.path}
									className={`uppercase block py-2 px-4 rounded hover:bg-white/20 ${
